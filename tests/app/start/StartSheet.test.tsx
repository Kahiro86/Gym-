...
describe("StartSheet", () => {
  it("renders nothing when closed", () => {
    ...
    render(<StartSheet open={false} onClose={() => {}} onStarted={() => {}} />, { wrapper: withDatabase(db) });
  ...
  it("shows an empty state when there are no saved routines", async () => {
    const db = new GymDatabase(uniqueDbName());
    render(<StartSheet open onClose={() => {}} onStarted={() => {}} />, { wrapper: withDatabase(db) });
  ...
  it("Free Workout starts an untagged session and calls onStarted", async () => {
    ...
    render(<StartSheet open onClose={() => {}} onStarted={onStarted} />, { wrapper: withDatabase(db) });
